...
const symbols = '~`!@#$%^&*()_-+={[}]|:;"<,>.?/';
//starting me password kya hai
//starting me password length 10 man rha hu
//starting me uppercase checkboc ko tick krkr de rha hai
//strting me indicator grey
...
function getRandomInteger(min, max) {
  ...
  //Ab anser 0 to (max-min) ka bich me aagya
...
//symbol ki string sa randomly index pkdkr uss index pe jo symbol pda hai woh deta hai
...
//slider ko jb bhi aage piche kr raha hun to slider ki vlue change ho rhi yeh woh value lakar de rha hai
